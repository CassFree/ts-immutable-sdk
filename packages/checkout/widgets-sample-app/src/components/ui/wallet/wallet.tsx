...
function WalletUI() {
    ...
    useEffect(() => {
        ...
        window.addEventListener(IMTBLWidgetEvents.IMTBL_WALLET_WIDGET_EVENT, handleWalletWidgetEvents);
        return () => {
            window.removeEventListener(IMTBLWidgetEvents.IMTBL_WALLET_WIDGET_EVENT, handleWalletWidgetEvents);
        }
    },[])
  return(
    <div className="Connect">
      <h1 className="sample-heading">Checkout Wallet (Web Component)</h1>
        <imtbl-wallet
            ...
            theme={WidgetTheme.DARK}></imtbl-wallet>
    </div>
  )
}
